...
input2 = csv.reader(open('datos/2.2-Nivel.csv','r'))

#2.1 Cambia /google+redesign/ por /pepe/
#2.2 Cambia /home por /juan y /google+redesign/ por /pepe/
#2.3 Cambia /home por /juan
