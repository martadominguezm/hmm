...
input2 = csv.reader(open('datos/1-Nivel.csv','r'))
input3 = csv.reader(open('datos/2-Nivel.csv','r'))
input4 = csv.reader(open('datos/3-Nivel.csv','r'))
input5 = csv.reader(open('datos/4-Nivel.csv','r'))
input1 = csv.reader(open('datos/5-Nivel.csv','r'))
