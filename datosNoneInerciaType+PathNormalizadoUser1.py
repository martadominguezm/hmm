...
top = int(max(max(pathTrain), max(pathTest), max(pathInt)))

for n in range (len(pathTrain)):
	pathTrain[n] = pathTrain[n]/top

for n in range (len(pathTest)):
	pathTest[n] = pathTest[n]/top

for n in range (len(pathInt)):
	pathInt[n] = pathInt[n]/top
